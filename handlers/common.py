...
# Глобальные словари для хранения данных (НУЖНЫ ДЛЯ ИМПОРТА В ДРУГИХ ФАЙЛАХ)
pending_transfers: Dict[str, Any] = {}
transfer_confirmations: Dict[str, Any] = {}
pending_msg_transfers: Dict[str, Any] = {}
mailing_data: Dict[int, Any] = {}
math_contest_pending: Dict[int, Any] = {}
LAST_CLICK_TIME: Dict[int, float] = {}
dice_cooldown: Dict[int, float] = {}

# Словари для сессий игр
MINES_SESSIONS: Dict[int, Any] = {}
GOLD_SESSIONS: Dict[int, Any] = {}
PYRAMID_SESSIONS: Dict[int, Any] = {}
TOWER_SESSIONS: Dict[int, Any] = {}
RR_SESSIONS: Dict[int, Any] = {}
BOWLING_SESSIONS: Dict[int, Any] = {}
KHB_GAMES: Dict[str, Any] = {}
KHB_DUELS: Dict[str, Any] = {}
COINFLIP_SESSIONS: Dict[int, Any] = {}
CASES_SESSIONS: Dict[int, Any] = {}
SPACESHIP_SESSIONS: Dict[int, Any] = {}
CRASH_SESSIONS: Dict[int, Any] = {}
DICE_SESSIONS: Dict[int, Any] = {}
ROULETTE_SESSIONS: Dict[int, Any] = {}
DARTS_SESSIONS: Dict[int, Any] = {}
...
def parse_bet_amount(amount_str, user_balance=None):
    """Парсит ставку с поддержкой 'всё'"""
    if not amount_str:
        return 0
