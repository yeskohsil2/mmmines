...
async def show_portfolio_page(query, context: ContextTypes.DEFAULT_TYPE, user_id: int):
...
async def handle_portfolio_pagination(query, context: ContextTypes.DEFAULT_TYPE, user_id: int, action: str):
...
async def show_shop_page(query, context: ContextTypes.DEFAULT_TYPE, user_id: int):
...
async def handle_shop_pagination(query, context: ContextTypes.DEFAULT_TYPE, user_id: int, action: str):
...
async def confirm_sell(query, context: ContextTypes.DEFAULT_TYPE, user_id: int, stock_id: int, quantity: int):
